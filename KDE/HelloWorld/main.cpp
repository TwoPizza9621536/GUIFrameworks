...
int main(int argc, char *argv[])
{
    ...
    KAbouteData aboutData(
            ...
            i18n("Tutorial form KDE Developer Docs"),
            // The program homepage string. (homePageAddress = QString())
            QStringLiteral("https://develop.kde.org/docs/getting-started/hello_world/"),
    ...
    return KMessageBox:questionYesNo(0, i18n("Hello World"), i18n("Hello"), yesButton)
        == KMessage::Yes? EXIT_SUCCESS: EXIT_FAILURE;
}
